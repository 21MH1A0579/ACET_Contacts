...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  Future<void> getImageData() async {
    final id = widget.designation=="PRINCIPAL"?"principal":widget.title;
    snapshot =
    ...
    Future<void> addContact() async {
      ...
      if (permission.isGranted) {
        ...
        Contact newContact = Contact(
          ...
          phones: [Item(label: "mobile", value: widget.phonenumber1),Item(label: "number2",value:widget.phonenumber2!="null"?widget.phonenumber2:" ")],
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: imageFound
                  ...
                  fit: BoxFit.cover,
                    ...
                    : Image.asset("asserts/no_image.png", fit: BoxFit.fill),
              ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        icon:  Icon(
                                          Icons.person_add_alt_1_rounded,color: Colors.green,),
                                      ),
                                    ],
                                  ),
                                )
                        ...
                        SizedBox(height: 10,),
                        widget.phonenumber2!="null"? Container(
                          height: 55,
                          decoration: BoxDecoration(
                              color: Colors.grey.shade200,
                              borderRadius: BorderRadius.circular(10)),
